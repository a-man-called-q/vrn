// Zitadel-only docker-compose services. Pulled out of the main block to
// keep the orchestrator small — this is one cohesive bundle of services
// that always ships together when `useZitadel` is true.

import type { ComposeValue } from "./types.js"

export function buildZitadelBlock(): Record<string, ComposeValue> {
  return {
    "zitadel-db": {
