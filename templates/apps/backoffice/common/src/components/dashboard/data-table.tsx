...
const chartOption = {
  ...
  xAxis: { type: "category", data: chartData.map((d) => d.month.slice(0, 3)), boundaryGap: false, axisLine: { show: false }, axisTick: { show: false }, axisLabel: { show: false } },
  ...
  series: [
    {
      ...
      symbol: "none",
      areaStyle: { opacity: 0.6, color: "var(--primary)" },
    ...
    },
    {
      ...
      symbol: "none",
      areaStyle: { opacity: 0.4, color: "var(--primary)" },
      lineStyle: { color: "var(--primary)" },
      itemStyle: { color: "var(--primary)" },
    },
  ],
  ...
  return (
    <Drawer direction={isMobile ? "bottom" : "right"}>
      <DrawerTrigger asChild>
        <Button variant="link" className="w-fit px-0 text-start text-foreground">{item.header}</Button>
      </DrawerTrigger>
      <DrawerContent>
        ...
        <div className="flex flex-col gap-4 overflow-y-auto px-4 text-sm">
          {!isMobile && (
            <>
              <EChart option={chartOption} style=\{{ height: 160, width: "100%" \}} notMerge />
              <Separator />
